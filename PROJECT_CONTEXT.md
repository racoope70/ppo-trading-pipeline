...
PROJECT_CONTEXT_alignment_effective_condition = FOCUSED_INDEPENDENT_TECHNICAL_ROOT_CAUSE_AUTHORIZATION_ALIGNMENT_CHECK_PASS_FINDINGS_NONE_AND_THIS_EXACT_THREE_FILE_ALIGNMENT_AND_FOCUSED_CHECK_COMMITTED_AND_PUSHED_AND_CI_GREEN_AND_AUTHORIZATION_SHA256_MATCH_AND_HEAD_ORIGIN_MAIN_MATCH_AND_WORKTREE_STAGING_CLEAN
...
authorization_transition_effective_condition = FOCUSED_INDEPENDENT_TECHNICAL_ROOT_CAUSE_AUTHORIZATION_ALIGNMENT_CHECK_PASS_FINDINGS_NONE_AND_THIS_EXACT_THREE_FILE_ALIGNMENT_AND_FOCUSED_CHECK_COMMITTED_AND_PUSHED_AND_CI_GREEN_AND_AUTHORIZATION_SHA256_MATCH_AND_HEAD_ORIGIN_MAIN_MATCH_AND_WORKTREE_STAGING_CLEAN
...
section_6_transition_effective_condition = FOCUSED_INDEPENDENT_TECHNICAL_ROOT_CAUSE_AUTHORIZATION_ALIGNMENT_CHECK_PASS_FINDINGS_NONE_AND_THIS_EXACT_THREE_FILE_ALIGNMENT_AND_FOCUSED_CHECK_COMMITTED_AND_PUSHED_AND_CI_GREEN_AND_AUTHORIZATION_SHA256_MATCH_AND_HEAD_ORIGIN_MAIN_MATCH_AND_WORKTREE_STAGING_CLEAN
...
local_import_surface_typeerror_technical_root_cause_authorization_source_of_truth_alignment_committed = NO
local_import_surface_typeerror_technical_root_cause_authorization_source_of_truth_alignment_pushed = NO
local_import_surface_typeerror_technical_root_cause_authorization_source_of_truth_alignment_CI_green = NO
...
3. After effectiveness only, permit exactly one bounded local diagnosis covering the four reviewed targets in one process with at most four probes and exactly one sanitized execution record.
...
bottom_line_transition_effective_condition = FOCUSED_INDEPENDENT_TECHNICAL_ROOT_CAUSE_AUTHORIZATION_ALIGNMENT_CHECK_PASS_FINDINGS_NONE_AND_THIS_EXACT_THREE_FILE_ALIGNMENT_AND_FOCUSED_CHECK_COMMITTED_AND_PUSHED_AND_CI_GREEN_AND_AUTHORIZATION_SHA256_MATCH_AND_HEAD_ORIGIN_MAIN_MATCH_AND_WORKTREE_STAGING_CLEAN
...
post_effectiveness_scope_does_not_authorize_second_process_retry_fallback_replacement_or_alternate_import = TRUE
