...
```txt
latest_completed_milestone = v2.94 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Closeout Review
latest_completed_tag = v2.94-ppo-v2-validation-reporting-scaffold-evidence-contract-usage-archived-chain-terminal-closeout-review
latest_completed_commit = pending v2.94 sealed checkpoint
active_milestone = v2.95 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Finalization Review
next_checkpoint = v2.95 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Finalization Review
...
v2.95 next checkpoint = validation reporting scaffold evidence contract usage archived chain terminal finalization review; no paper/live/controlled submit
```
