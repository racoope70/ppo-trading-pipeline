...
```txt
latest_completed_milestone = v2.97 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Final Closure Review
latest_completed_tag = v2.97-ppo-v2-validation-reporting-scaffold-evidence-contract-usage-archived-chain-terminal-final-closure-review
latest_completed_commit = pending v2.97 sealed checkpoint
active_milestone = v2.98 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Final Closure Closeout Review
next_checkpoint = v2.98 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Final Closure Closeout Review
...
v2.98 next checkpoint = validation reporting scaffold evidence contract usage archived chain terminal final closure closeout review; no paper/live/controlled submit
```
