...
```txt
latest_completed_milestone = v2.23 PPO v2 One-Time No-Submit Controlled Training Execution Authorization Review
latest_completed_tag = v2.23-ppo-v2-one-time-no-submit-controlled-training-execution-authorization-review
latest_completed_commit = pending v2.23 sealed checkpoint
active_milestone = v2.24 PPO v2 One-Time No-Submit Controlled Training Execution Final Preflight Review
next_checkpoint = v2.24 PPO v2 One-Time No-Submit Controlled Training Execution Final Preflight Review
...
v2.24 next checkpoint = one-time no-submit controlled training execution final preflight review; no training execution
```
