...
The current checkpoint authorizes dataset-generation re-execution only. Dataset validation and all later activity remain separately governed and unauthorized.
