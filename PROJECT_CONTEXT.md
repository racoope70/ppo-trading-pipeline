...
```txt
latest_completed_milestone = v2.95 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Finalization Review
latest_completed_tag = v2.95-ppo-v2-validation-reporting-scaffold-evidence-contract-usage-archived-chain-terminal-finalization-review
latest_completed_commit = pending v2.95 sealed checkpoint
active_milestone = v2.96 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Finalization Closeout Review
next_checkpoint = v2.96 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Finalization Closeout Review
...
v2.96 next checkpoint = validation reporting scaffold evidence contract usage archived chain terminal finalization closeout review; no paper/live/controlled submit
```
