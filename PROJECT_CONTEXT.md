...
```txt
latest_completed_milestone = v2.89 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Finalization Review
latest_completed_tag = v2.89-ppo-v2-validation-reporting-scaffold-evidence-contract-usage-archived-chain-finalization-review
latest_completed_commit = pending v2.89 sealed checkpoint
active_milestone = v2.90 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Finalization Closeout Review
next_checkpoint = v2.90 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Finalization Closeout Review
...
v2.90 next checkpoint = validation reporting scaffold evidence contract usage archived chain finalization closeout review; no paper/live/controlled submit
```
