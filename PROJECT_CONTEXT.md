...
```txt
latest_completed_milestone = v2.96 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Finalization Closeout Review
latest_completed_tag = v2.96-ppo-v2-validation-reporting-scaffold-evidence-contract-usage-archived-chain-terminal-finalization-closeout-review
latest_completed_commit = pending v2.96 sealed checkpoint
active_milestone = v2.97 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Final Closure Review
next_checkpoint = v2.97 PPO v2 Validation Reporting Scaffold Evidence Contract Usage Archived Chain Terminal Final Closure Review
...
v2.97 next checkpoint = validation reporting scaffold evidence contract usage archived chain terminal final closure review; no paper/live/controlled submit
```
