...
The current checkpoint is dataset-generation re-execution authorization consideration only. Re-execution, requirements changes, dataset validation, and all later activity remain separately governed and unauthorized.
