...
|---|---|---|---:|---:|---:|---|---:|---|---|
| reports/paper_trading_dry_runs/latest | SINGLE_NEW_CANDIDATE | NO_SUBMIT | 1 | 0 | 1 | False | 0 | True | One candidate appeared, but no prior candidate was provided for persistence validation. |
