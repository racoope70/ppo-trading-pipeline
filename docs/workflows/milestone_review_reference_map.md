...
The current checkpoint is authorization-consideration-only and authorizes no execution. Root-cause analysis, remediation, dataset validation, training, orders, deployment, and tagging remain unauthorized.
