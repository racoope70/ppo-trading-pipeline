...
2. Reference the four-file documentation-only corrected exact-command post-CI provenance-finalization package for human review and later separately authorized commit, push, and CI consideration.
