...
The current checkpoint authorizes read-only missing-slot root-cause analysis only. Remediation, dataset validation, training, orders, deployment, and tagging remain unauthorized.
