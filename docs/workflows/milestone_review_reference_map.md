...
2. Reference only the current four-file documentation-only non-recursive finalization package for final review and, after explicit authorization, staging, commit, push, and CI consideration.
